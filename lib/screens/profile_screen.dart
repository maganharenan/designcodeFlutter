...
import 'package:designcode/components/lists/certificate_viewer.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
                      ...
                      child: Row(
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Text("Renan Maganha", style: kTitle2Style,),
                              SizedBox(height: 8.0,),
                              Text("iOS Developer", style: kSecondaryCalloutLabelStyle,),
                            ],
                          ),
                        ],
                      ),
            ...
            Padding(
              padding: EdgeInsets.only(top: 32.0, left: 20.0, right: 20.0, bottom: 12.0),
              child: Column(
                children: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
